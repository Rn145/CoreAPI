...
Инициализируем все ваши библиотеки для CoreAPI, указав в какой директории они хранятся.
В конце вам нужно каким-либо образом подключить CoreAPI/client в renderer процесс.
В CoreAPI уже есть готовый preload файл с подключением CoreAPI/client как window.CoreAPI;
...
Дабы избежать конфликтов с другими библиотеками рекумендуем выбирать имена методов по шаблону "имяБиблиотеки.имяМетода".
...
import CoreAPI from 'CoreAPI'
// или import CoreAPI from 'CoreAPI/main'
...
## API renderer process (CoreAPI/client)
