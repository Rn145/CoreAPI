...
В конце вам нужно каким-либо образом подключить ElectronCoreAPI/client в renderer процесс.
В CoreAPI уже есть готовый preload файл с подключением ElectronCoreAPI/client как window.CoreAPI;
